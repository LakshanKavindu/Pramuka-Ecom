      ...
      <ul className="my-4 space-y-3">
        <li>
          ...
          >
            <div className="flex items-center">
              ...
              <span className="ml-3 whitespace-nowrap">Biscuit</span>
            </div>
            <span className="flex items-center">
              <span className="ml-3 flex-1">12</span>
        ...
        <li>
          ...
          >
            <div className="flex items-center">
              <img src="https://img.icons8.com/?size=100&id=gD9WHI7lKKYP&format=png&color=000000" className="h-6 w-6" alt="icon" />
              <span className="ml-3 whitespace-nowrap">Chocolate</span>
            </div>
            <span className="flex items-center">
              <span className="ml-3 flex-1">14</span>
              <span className="ml-3 inline-flex items-center justify-center rounded bg-gray-200 px-2 py-0.5 text-xs font-medium text-gray-500 dark:bg-gray-700 dark:text-gray-400">
                Popular
              </span>
            </span>
